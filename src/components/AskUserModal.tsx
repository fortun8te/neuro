...
export function AskUserModal({ request, onResponse }: AskUserModalProps) {
  ...
  const borderColor = isClarification ? 'rgba(59,130,246,0.35)' : 'rgba(255,255,255,0.1)';
            ...
            <div style={{ marginTop: 16, display: 'flex', gap: 8 }}>
              <input
                ...
                style={{
                  ...
                  padding: '9px 12px',
                  borderRadius: 8,
                  border: `1px solid ${isClarification ? 'rgba(59,130,246,0.30)' : 'rgba(255,255,255,0.12)'}`,
              ...
              <button
                ...
                style={{
                  padding: '9px 16px',
                  borderRadius: 8,
                  border: `1px solid ${isClarification ? 'rgba(59,130,246,0.30)' : 'rgba(255,255,255,0.15)'}`,
                  background: isClarification ? 'rgba(59,130,246,0.18)' : 'rgba(43,121,255,0.2)',
