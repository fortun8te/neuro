  ...
  return (
    ...
    >
      {items.map((item, i) => (
        ...
        >
          <span style={{ color: item.danger ? '#f87171' : 'rgba(255,255,255,0.4)', display: 'flex', alignItems: 'center' }}>
            {item.icon}
          </span>
          {item.label}
        </button>
  ...
  return (
    <input
      ...
      style={{
        ...
        border: '1px solid rgba(43,121,255,0.7)',
        borderRadius: 3,
        outline: 'none',
        padding: '1px 4px',
        width: '100%',
  ...
  return (
    <input
      ...
      style={{
        ...
        border: '1px solid rgba(43,121,255,0.6)',
        borderRadius: 3,
        outline: 'none',
        padding: '1px 4px',
        width: '100%',
          ...
          <span
            style={{
              ...
              color: node.type === 'folder'
                ...
                : (extColor ?? 'rgba(255,255,255,0.65)'),
            }}
          >
            {node.name}
          </span>
