      ...
      <div className="fixed inset-0 flex items-center justify-center z-[901] pointer-events-none">
        ...
        >
          ...
          <div className="px-5 pt-3 flex items-center justify-between">
            <div className="inline-flex rounded-lg p-0.5" style={{ background: 'rgba(255,255,255,0.04)' }}>
                    ...
                    <div className="rounded-xl overflow-hidden" style={{ border: '1px solid rgba(255,255,255,0.05)' }}>
                      ...
                      {topFiles.map((f, i) => (
                        <div
                          ...
                          style={{
                            background: 'transparent',
                            borderTop: (topFolders.length > 0 || i > 0) ? '1px solid rgba(255,255,255,0.04)' : undefined,
                          }}
                          onMouseEnter={e => (e.currentTarget.style.background = 'rgba(255,255,255,0.03)')}
                          onMouseLeave={e => (e.currentTarget.style.background = 'transparent')}
                        >
