  ...
  return (
    <motion.div
      ...
      style={{
        width: size,
        height: size,
        background: 'linear-gradient(135deg, #4d9aff, #3b82f6, #1a5fd4)',
      ...
      animate={{
        ...
        boxShadow: [
          `0 0 ${size * 0.3}px rgba(234,88,12,0.2), 0 0 ${size * 0.6}px rgba(234,88,12,0.06)`,
          `0 0 ${size * 0.5}px rgba(77,154,255,0.35), 0 0 ${size}px rgba(234,88,12,0.12)`,
          `0 0 ${size * 0.3}px rgba(234,88,12,0.2), 0 0 ${size * 0.6}px rgba(234,88,12,0.06)`,
        ],
...
function ActionPill({
  ...
  const getBackground = () => {
    ...
    return dark
      ? (isExpanded
        ? 'linear-gradient(to right, rgba(234,88,12,0.06), rgba(39,39,42,0.8))'
        : 'linear-gradient(to right, rgba(234,88,12,0.03), rgba(24,24,27,0.6))')
      : (isExpanded
        ? 'linear-gradient(to right, rgba(234,88,12,0.05), rgba(244,244,245,1))'
        : 'linear-gradient(to right, rgba(234,88,12,0.02), rgba(250,250,250,1))');
  };
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="flex items-center gap-3">
          ...
          <TextShimmer className="text-sm [--shimmer-base:rgba(234,88,12,0.3)] [--shimmer-highlight:rgba(234,88,12,0.9)]" duration={1.8}>Starting research agents...</TextShimmer>
        </div>
      </div>
    );
  }
      ...
      <div ref={feedRef} className="flex-1 overflow-y-auto min-h-0 px-5 py-4">
        ...
        {isRunning && (
          <div className="flex items-center gap-2.5 py-3 mt-2">
            <ManusBlob size={14} />
            <TextShimmer className="text-[13px] [--shimmer-base:rgba(234,88,12,0.3)] [--shimmer-highlight:rgba(234,88,12,0.9)]" duration={1.8}>Thinking</TextShimmer>
          </div>
        )}
      </div>
    </div>
