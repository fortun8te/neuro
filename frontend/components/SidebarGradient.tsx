...
function CSSFallbackGradient() {
  ...
  return (
    <div
      ...
      style={{
        background: [
          'radial-gradient(ellipse 55% 60% at 25% 50%, rgba(234,88,12,0.08) 0%, transparent 100%)',
          'radial-gradient(ellipse 50% 50% at 75% 30%, rgba(234,88,12,0.04) 0%, transparent 100%)',
          '#000',
        ].join(', '),
