  ...
  return (
    <button
      ...
      style={{
        width: size,
        height: size,
        background: recording ? 'rgba(239,68,68,0.15)' : 'var(--glass-border-light)',
        border: `1px solid ${recording ? 'rgba(239,68,68,0.4)' : 'var(--glass-border-light)'}`,
        color: recording ? '#ef4444' : 'var(--text-muted)',
        boxShadow: recording ? '0 0 12px rgba(239,68,68,0.3), 0 0 4px rgba(239,68,68,0.15)' : 'none',
