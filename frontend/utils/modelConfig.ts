...
export const RESEARCH_PRESETS: ResearchPresetDef[] = [
  ...
  },
  {
    ...
    label: 'Standard',
    shortLabel: 'Standard',
    description: 'Thorough analysis, production quality — 300+ sources',
    time: '~90 min',
    color: 'blue',
    limits: {
      maxIterations: 50,
  ...
  },
  {
    ...
    label: 'Deep',
    shortLabel: 'Deep',
    description: 'Deep dive — 1000+ sources, visual analysis, cross-validation',
    time: '~3 hrs',
    color: 'sky',
    limits: {
      maxIterations: 100,
  ...
  },
  {
    ...
    label: 'Maximum',
    shortLabel: 'Max',
    description: 'Exhaustive — 5000+ sources, every angle, every language, deep visuals',
    time: '~6-8 hrs',
    color: 'red',
    limits: {
      maxIterations: 200,
      minIterations: 60,
      coverageThreshold: 0.997,
      minSources: 5000,
      maxResearchersPerIteration: 30,
      maxTimeMinutes: 480,
