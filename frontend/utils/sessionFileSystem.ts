/**
 * sessionFileSystem.ts — Session-aware virtual filesystem for the Neuro agent.
 *
...
export class SessionFileSystem {
  ...
  async persist(): Promise<void> {
    // IndexedDB is browser-only — skip in CLI/Node.js context
